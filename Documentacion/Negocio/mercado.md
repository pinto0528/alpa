...
La brecha se reducirá al: (a) incorporar financiamiento (ANR, Fondo Semilla) para producción tercerizada, (b) sumar canales de venta (aseguradoras, cooperativas), y (c) agregar roles al equipo (técnico de campo, desarrollador). Ver proyecciones detalladas en `proyecciones.md`.
...
> **Nota:** Esta estimación representa el **mercado total capturable (SOM)** asumiendo que no existieran restricciones de oferta. Las proyecciones reales de ventas del equipo, limitadas por capacidad operativa y escalamiento progresivo, se detallan en `proyecciones.md`.
