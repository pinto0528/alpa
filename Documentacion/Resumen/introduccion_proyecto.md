...
> Este proyecto fue iniciado en el marco del programa EmprendeU 2026 y continúa como proyecto independiente.
...
Este documento forma parte de un conjunto mayor de documentación del proyecto Sistema de Alerta de Incendios Rurales. Incluye secciones de contexto del problema, solución técnica, modelo de negocio, validación con usuarios, análisis financiero e impacto esperado.
